...
namespace Epp.Plugin.Soft2Print
{
    ...
    /// </summary>
    public static class Soft2PrintDefaults
    {
        /// <summary>
        /// Gets a name of the view component to embed tracking script on pages
        /// </summary>
        public const string TRACKING_VIEW_COMPONENT_NAME = "Soft2Print";

        /// <summary>
        /// Gets a plugin system name
        /// </summary>
        public static string SystemName => "Epp.Plugin.Soft2Print";
        ...
        /// <summary>
        /// Gets a user agent used to request soft2print services
        /// </summary>
        public static string UserAgent => $"nopCommerce-{NopVersion.CURRENT_VERSION}";

        /// <summary>
        /// Gets a URL to edit message template on soft2print account
        /// </summary>
        ...
        /// </summary>
        public static string ImportContactsRoute => "Plugin.Misc.Soft2Print.ImportContacts";

        /// <summary>
        /// Gets a name of the route to the addtocart callback
        /// </summary>
        public static string AddToCartRoute => "Plugin.Misc.Soft2Print.AddToCart";

        /// <summary>
        /// Gets a name of the route to the design callback
        /// </summary>
        public static string DesignRoute => "Plugin.Misc.Soft2Print.Design";


        /// <summary>
        /// Gets a name of the route to the unsubscribe contact callback
        /// </summary>
        public static string UnsubscribeContactRoute => "Plugin.Misc.Soft2Print.Unsubscribe";
        ...
        /// </summary>
        public static string SynchronizationTask => "Epp.Plugin.Soft2Print.Services.SynchronizationTask";
