...
namespace Epp.Plugin.Soft2Print.Services
{
    ...
    public class SendinblueEmailSender : EmailSender
    {
        ...
        private readonly Soft2PrintSettings _sendinblueSettings;
        ...
        public SendinblueEmailSender(IDownloadService downloadService,
            ...
            Soft2PrintSettings sendinblueSettings) : base(downloadService, fileProvider, smtpBuilder)
        {
            ...
            int attachedDownloadId = 0, IDictionary<string, string> headers = null)
        {
            ...
            if (emailAccount.Id == _sendinblueSettings.EmailAccountId)
            {
                ...
                headers.Add(Soft2PrintDefaults.EmailCustomHeader, store.Id.ToString());
            }
